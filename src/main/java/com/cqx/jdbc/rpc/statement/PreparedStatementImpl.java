...
public class PreparedStatementImpl extends StatementImpl implements PreparedStatement {
    ...
    /**
     * orginalSql 按？拆分
     * 比如 select * from user where name = ? and age = ? order by id desc; 拆分后是
     ...
     * 5. order by id desc;
     */
    private List<String> sqlParts = new ArrayList<>();

    public PreparedStatementImpl(RpcConnection rpcConnection, String sql) {
        super(rpcConnection);
        this.originalSql = sql;
        String[] split = sql.split("\\?");
        for (int i = 0; i < split.length; i++) {
            sqlParts.add(split[i]);
            sqlParts.add("?");
        }
    }

    public PreparedStatementImpl(RpcConnection rpcConnection) {
        super(rpcConnection);
    }
    ...
    public ResultSet executeQuery() throws SQLException {
        return super.executeQuery(sqlParts.stream().collect(Collectors.joining()));
    }
    ...
    public void setNull(int parameterIndex, int sqlType) throws SQLException {
        sqlParts.set(parameterIndex * 2 - 1, "NULL");
    }
    ...
    public void setBoolean(int parameterIndex, boolean x) throws SQLException {
        sqlParts.set(parameterIndex * 2 - 1, String.valueOf(x));
    }
    ...
    public void setByte(int parameterIndex, byte x) throws SQLException {
        throw new JdbcRpcException("不支持");
    }
    ...
    public void setBigDecimal(int parameterIndex, BigDecimal x) throws SQLException {
        sqlParts.set(parameterIndex * 2 - 1, x.toPlainString());
    }
...
//        sqlParts.set(parameterIndex * 2 - 1, new SimpleDateFormat().format(x));
        throw new JdbcRpcException("暂时不支持");
    }
