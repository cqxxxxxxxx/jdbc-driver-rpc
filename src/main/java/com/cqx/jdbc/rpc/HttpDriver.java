...
import com.cqx.jdbc.rpc.client.HttpUrlConnectionClient;
...
public class HttpDriver implements RpcDriver {
    private static final String PROTOCOL = "jdbc:http://";
    ...
    public Connection connect(String url, Properties info) throws SQLException {
         ...
         */
        com.cqx.jdbc.rpc.RpcClient rpcClient;
        switch (conInfo.rpcClientType) {
            default:
                rpcClient = new HttpUrlConnectionClient(conInfo);
        }
    ...
    /**
     * 通常来说，drivers如果能解析url的协议那么就返回true，否则false。
     * jdbc-http driver的协议以jdbc:http://开头
     *
